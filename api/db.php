...
do {
    ...
    foreach ($obj->results as $payment) {
        ...
        $palavras_bloqueadas = [
            'pagamento teste pix -',
            'point product for card payments via bluetooth.',
            'test',
            'breno marinho severino',
            'breno',
            'breno marinho',
            'Relógio Suiço Old Money Luxo Minialista C/caixa E Ajustador',
            'Pago Bank Transfer Pix',
            'Nome nào disponível',
            'Nome não disponível',
            'Venda presencial',
            'Venda presencial (2 produtos selecionados)',
            'Venda presencial (3 produtos selecionados)'
        ];
